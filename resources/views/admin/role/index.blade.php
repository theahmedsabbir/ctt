                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td><input type="checkbox" name="permissions[]" value="department" style="cursor: pointer;"></td>
                                    </tr>
                                    <tr>
                                      <td style="text-transform: capitalize;">teacher</td>
                                      <td><input type="checkbox" name="permissions[]" value="teacher" style="cursor: pointer;"></td>
                                    </tr>
                                    <tr>
                                      <td style="text-transform: capitalize;">stuff</td>
                                      <td><input type="checkbox" name="permissions[]" value="stuff" style="cursor: pointer;"></td>
                                    </tr>
                                    <tr>
                                      <td style="text-transform: capitalize;">student</td>
                                      <td><input type="checkbox" name="permissions[]" value="student" style="cursor: pointer;"></td>
                                    </tr>
                                    <tr>
                                      <td style="text-transform: capitalize;">post</td>
                                      <td><input type="checkbox" name="permissions[]" value="post" style="cursor: pointer;"></td>
                                    </tr>
                                    <tr>
                                      <td style="text-transform: capitalize;">accounts</td>
                                      <td><input type="checkbox" name="permissions[]" value="accounts" style="cursor: pointer;"></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
