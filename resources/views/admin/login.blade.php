...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <link rel="icon" href="{{ asset('admin/images/icon_short.png') }}" type="image/x-icon" />
    ...
    <div class="row no-gutters flex-row-reverse ht-100v">
      ...
      <div class="col-md-6 bg-br-primary d-flex align-items-center justify-content-center">
        <div class="wd-250 wd-xl-450 mg-y-30">
          <div class="signin-logo tx-28 tx-bold tx-white"><span class="tx-normal">[</span> CTT <span class="tx-info">Polytechnic Institute</span> <span class="tx-normal">]</span></div>
          <div class="tx-white mg-b-60">The Admin Panel For CTT</div>
