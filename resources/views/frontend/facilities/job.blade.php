...
<div class="main-content">
    ...
    @include('frontend.includes.inner-header', ['title' => 'Job Placement', 'breadcrumb' => 'Job Placement'])
    ...
    <section id="courses" class="chairman">
      <div class="container">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase title">Job Placement Centre</h2>
        ...
        <div class="row mtli-row-clearfix">
        	...
        	<div class="col-md-12">
        		<div class="right text-center">
        			<img src="{{ asset('frontend/images/1/20181124_090416.JPG') }}" alt="" class="img-fluid">
        		</div>
        	</div>
        	<div class="col-md-12">
        		<div class="left">
