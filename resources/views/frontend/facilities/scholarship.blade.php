...
<div class="main-content">
    ...
    @include('frontend.includes.inner-header', ['title' => 'Scholarship', 'breadcrumb' => 'Scholarship'])
    ...
    <section id="courses" class="chairman">
      <div class="container">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase title">Scholarship</h2>
        ...
        <div class="row mtli-row-clearfix">
        	...
        	<div class="col-md-12">
        		<div class="right text-center">
        			<img src="{{ asset('frontend/images/1/IMG_20181124_153311.JPG') }}" alt="" class="img-fluid">
        		</div>
        	</div>
        	<div class="col-md-12">
        		<div class="left">
